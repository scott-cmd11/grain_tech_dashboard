...
export function ChatWidget() {
    ...
    const [messages, setMessages] = useState<ChatMessage[]>([
        { role: 'model', parts: "Hi! I'm the GrainTech AI Assistant. I can answer questions about grain grading technology, regulations, and companies listed on this dashboard. How can I help?" }
    ]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Pass history excluding the very first welcome message if specific API logic desires, 
        // but here we pass full visible history properly filtered if needed.
        // We filter out the 'model' role welcome message if we want pure chat history 
        // or keep it if we want the bot to remember it said hi. 
